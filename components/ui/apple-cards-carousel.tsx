...
import { useOutsideClick } from "@/app/hooks/use-outside-hooks";
		...
		<>
				...
				{open && (
					<div className="fixed inset-0 h-screen z-50 overflow-auto">
						...
						>
							...
							{/* <motion.p
								layoutId={
									layout ? `author-${card.title}` : undefined
								}
							...
							<div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center py-10">
								...
								<div className="flex flex-col gap-5 px-5 py-10">
									<div>
										...
										<h2 className="text-2xl md:text-5xl text-neutral-700 mt-4 dark:text-white font-bold">
											{card.title}
										</h2>
									</div>
			...
			>
				...
				<div className="relative z-40 p-8">
					<motion.p
						layoutId={layout ? `author-${card.author}` : undefined}
